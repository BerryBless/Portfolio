...
// OnCollision(IObject *obj)	: this 오브젝트와 obj 가 충돌했을때 [(가해자)->OnCollision(피해자)]
...
public:
	...
	bool		_collision;						// 이 오브젝트를 충돌처리 하냐(true) 안하냐(false)
...
public:
	...
	virtual void OnCollision(IObject *obj) {};	// this 오브젝트와 obj 가 충돌했을때 [(가해자)->OnCollision(피해자)]
